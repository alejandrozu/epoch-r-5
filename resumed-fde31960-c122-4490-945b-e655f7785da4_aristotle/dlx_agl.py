...
for i, q_orb in enumerate(q_orbit_list):
    # What r-orbits does ONE FULL ORBIT of q_orb cover?
    # Generate the full orbit of q_orb
    q_orbit_set = set()
    for p in perms:
    ...
    # Check if this q-orbit covers its r-orbits exactly proportionately to their orbit size
    valid = True
